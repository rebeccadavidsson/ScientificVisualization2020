d3.slider = function module() {
    ...
    function slider(selection) {
        selection.each(function () {
            ...
            //     .call(axis)
            const years = ['1970', '1971', '1972', '1973', '1974', '1975', '1976', '1977', '1978', '1979', '1980', '1981', '1982', '1983'];

            svg.selectAll("circles")
                .data(years)
                .enter()
                .append("circle")
                .attr("cx", function (d) { return scale(parseInt(d)) })
            ...
            svg.selectAll("circles")
                ...
                .attr("transform", function(d) {
                    return "translate(" + (scale(parseInt(d)) - 13)  + "," + (rectHeight + 17)  + ")"
                })
                .text(function(d) { return d })

         
            var values = [value.toString().replace(",", "")];
